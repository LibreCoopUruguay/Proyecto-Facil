...
/**
 * Devuelve todos los ID de usuarios (cooperativas) que son proveedoras del rubro $rubroTid
 */
function bootstrap_business_UsuariosXRubro ($rubroTid) {
...
function bootstrap_business_form_element($variables) {

	return '<div class="algo">'. theme_form_element($variables) . '</div>';
...
function bootstrap_business_theme() {
  $items = array();
  ...
  $items['user_register_form'] = array(
    ...
    'preprocess functions' => array(
      'bootstrap_business_preprocess_user_register_form'
    ),
  );
  return $items;
}

function bootstrap_business_preprocess_user_register_form(&$vars) {
